...
public class MySentence {
    ...
    public static void main(String[] args) {
        ...
        CompletableFuture<String> keyboardFuture = CompletableFuture.supplyAsync(keyboard);
        CompletableFuture<String> concatFuture = CompletableFuture.supplyAsync(concatenator);
